...
import java.util.*;
import java.util.ArrayList; // Changed from HashSet
...
public class OrderCommandServiceImpl implements OrderCommandService {
    ...
    private String generatePaymentToken(Long orderId, BigDecimal amount) {
        // Placeholder for actual payment gateway token generation logic
        // In a real scenario, this would involve calling an external payment service.
        return "mock_token_" + orderId + "_" + amount.toPlainString().replace(".", "");
    }
